...
{
    /// <inheritdoc />
    public partial class AddWishlistPromotionCouponBoxReviewStock : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BoxReviews", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BoxReviews_BoxTypes_BoxTypeId",
                        column: x => x.BoxTypeId,
                        principalTable: "BoxTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BoxReviews_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BoxReviews_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BoxReviews_BoxTypeId",
                table: "BoxReviews",
                column: "BoxTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_BoxReviews_OrderId",
                table: "BoxReviews",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_BoxReviews_UserId",
                table: "BoxReviews",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_BoxReviews_UserId_OrderId_BoxTypeId",
                table: "BoxReviews",
                columns: new[] { "UserId", "OrderId", "BoxTypeId" },
                unique: true);
