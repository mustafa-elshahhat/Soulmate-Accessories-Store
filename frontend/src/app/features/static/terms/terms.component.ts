  ...
  template: `
    ...
    <section class="relative bg-gradient-to-br from-[#1A1A1A] via-[#242424] to-[#1A1A1A] overflow-hidden">
      ...
      <div class="max-w-[1280px] mx-auto px-4 py-16 md:py-24 text-center relative z-10">
        <p class="fade-up text-[#C8A96E] text-sm tracking-[0.2em] uppercase mb-4 font-medium">{{ 'terms.hero.label' | t }}</p>
        <h1 class="fade-up-d1 font-playfair text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-5">{{ 'terms.hero.title' | t }}</h1>
        <div class="fade-up-d2 w-12 h-px bg-[#C8A96E] mx-auto mb-6"></div>
        <p class="text-neutral-400 text-sm">{{ 'terms.hero.lastUpdated' | t }}</p>
      </div>
    </section>
        ...
        <div class="space-y-6">
          ...
          <div class="policy-section border border-border rounded-xl p-6 md:p-8">
            <div class="flex items-center gap-3 mb-5">
              ...
              <h2 class="font-playfair text-xl md:text-2xl font-bold text-foreground">{{ 'terms.section1.title' | t }}</h2>
            </div>
            <div class="space-y-3 text-muted-foreground">
              <div class="flex items-start gap-3">
                <span class="w-1.5 h-1.5 rounded-full bg-[#C8A96E] mt-2.5 shrink-0"></span>
                <p>{{ 'terms.section1.item1' | t }}</p>
              </div>
              <div class="flex items-start gap-3">
                <span class="w-1.5 h-1.5 rounded-full bg-[#C8A96E] mt-2.5 shrink-0"></span>
                <p>{{ 'terms.section1.item2' | t }}</p>
              </div>
              <div class="flex items-start gap-3">
                <span class="w-1.5 h-1.5 rounded-full bg-[#C8A96E] mt-2.5 shrink-0"></span>
                <p>{{ 'terms.section1.item3' | t }}</p>
              </div>
              <div class="flex items-start gap-3">
                <span class="w-1.5 h-1.5 rounded-full bg-[#C8A96E] mt-2.5 shrink-0"></span>
                <p>{{ 'terms.section1.item4' | t }}</p>
              </div>
            </div>
          </div>
          ...
          <div class="policy-section border border-border rounded-xl p-6 md:p-8">
            <div class="flex items-center gap-3 mb-5">
              ...
              <h2 class="font-playfair text-xl md:text-2xl font-bold text-foreground">{{ 'terms.section2.title' | t }}</h2>
            </div>
            <div class="space-y-3 text-muted-foreground">
              <div class="flex items-start gap-3">
                <span class="w-1.5 h-1.5 rounded-full bg-[#C8A96E] mt-2.5 shrink-0"></span>
                <p>{{ 'terms.section2.item1' | t }}</p>
              </div>
              <div class="flex items-start gap-3">
                <span class="w-1.5 h-1.5 rounded-full bg-[#C8A96E] mt-2.5 shrink-0"></span>
                <p>{{ 'terms.section2.item2' | t }}</p>
              </div>
              <div class="flex items-start gap-3">
                <span class="w-1.5 h-1.5 rounded-full bg-[#C8A96E] mt-2.5 shrink-0"></span>
                <p>{{ 'terms.section2.item3' | t }}</p>
              </div>
              <div class="flex items-start gap-3">
                <span class="w-1.5 h-1.5 rounded-full bg-[#C8A96E] mt-2.5 shrink-0"></span>
                <p>{{ 'terms.section2.item4' | t }}</p>
              </div>
            </div>
            <div class="bg-[#C8A96E]/5 border border-[#C8A96E]/20 rounded-xl p-4 mt-5">
              <p class="text-sm text-muted-foreground">
                <strong class="text-foreground">{{ 'common.note' | t }}</strong>
                {{ 'terms.section2.note' | t }}
              </p>
            </div>
          </div>
          ...
          <div class="policy-section border border-border rounded-xl p-6 md:p-8">
            <div class="flex items-center gap-3 mb-5">
              ...
              <h2 class="font-playfair text-xl md:text-2xl font-bold text-foreground">{{ 'terms.section3.title' | t }}</h2>
            </div>
            <div class="space-y-3 text-muted-foreground">
              <div class="flex items-start gap-3">
                <span class="w-1.5 h-1.5 rounded-full bg-[#C8A96E] mt-2.5 shrink-0"></span>
                <p>{{ 'terms.section3.item1' | t }}</p>
              </div>
              <div class="flex items-start gap-3">
                <span class="w-1.5 h-1.5 rounded-full bg-[#C8A96E] mt-2.5 shrink-0"></span>
                <p>{{ 'terms.section3.item2' | t }}</p>
              </div>
              <div class="flex items-start gap-3">
                <span class="w-1.5 h-1.5 rounded-full bg-[#C8A96E] mt-2.5 shrink-0"></span>
                <p>{{ 'terms.section3.item3' | t }}</p>
              </div>
            </div>
          </div>
          ...
          <div class="policy-section border border-border rounded-xl p-6 md:p-8">
            <div class="flex items-center gap-3 mb-5">
              ...
              <h2 class="font-playfair text-xl md:text-2xl font-bold text-foreground">{{ 'terms.section4.title' | t }}</h2>
            </div>
            <div class="space-y-3 text-muted-foreground">
              <div class="flex items-start gap-3">
                <span class="w-1.5 h-1.5 rounded-full bg-[#C8A96E] mt-2.5 shrink-0"></span>
                <p>{{ 'terms.section4.item1' | t }}</p>
              </div>
              <div class="flex items-start gap-3">
                <span class="w-1.5 h-1.5 rounded-full bg-[#C8A96E] mt-2.5 shrink-0"></span>
                <p>{{ 'terms.section4.item2' | t }}</p>
              </div>
              <div class="flex items-start gap-3">
                <span class="w-1.5 h-1.5 rounded-full bg-[#C8A96E] mt-2.5 shrink-0"></span>
                <p>{{ 'terms.section4.item3' | t }}</p>
              </div>
            </div>
          </div>
          ...
          <div class="policy-section border border-border rounded-xl p-6 md:p-8">
            <div class="flex items-center gap-3 mb-5">
              ...
              <h2 class="font-playfair text-xl md:text-2xl font-bold text-foreground">{{ 'terms.section5.title' | t }}</h2>
            </div>
            <p class="text-muted-foreground">
              {{ 'terms.section5.body' | t }}
            </p>
          </div>
          ...
          <div class="policy-section border border-border rounded-xl p-6 md:p-8">
            <div class="flex items-center gap-3 mb-5">
              ...
              <h2 class="font-playfair text-xl md:text-2xl font-bold text-foreground">{{ 'terms.section6.title' | t }}</h2>
            </div>
            <p class="text-muted-foreground">
              {{ 'terms.section6.body' | t }}
            </p>
          </div>
          ...
          <div class="policy-section border border-border rounded-xl p-6 md:p-8">
            <div class="flex items-center gap-3 mb-5">
              <div class="w-8 h-8 bg-[#C8A96E]/10 rounded-full flex items-center justify-center shrink-0">
                <span class="text-[#C8A96E] text-sm font-bold">7</span>
              </div>
              <h2 class="font-playfair text-xl md:text-2xl font-bold text-foreground">{{ 'terms.section7.title' | t }}</h2>
            </div>
            <p class="text-muted-foreground mb-4">
              {{ 'terms.section7.body' | t }}
            </p>
...
export class TermsComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.seoService.updatePage({
      title: this.t.get('terms.seo.title'),
      description: this.t.get('terms.seo.description'),
      url: '/terms',
    });
  }
}
