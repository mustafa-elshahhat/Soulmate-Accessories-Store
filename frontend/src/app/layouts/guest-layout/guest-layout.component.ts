      ...
      <div class="border-b border-white/10">
        <div class="max-w-[1280px] mx-auto px-6 lg:px-8 py-12 md:py-16 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div class="flex items-center gap-4">
            ...
            <a [href]="contact.WHATSAPP_URL" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" class="w-11 h-11 rounded-full border border-white/15 flex items-center justify-center text-white/60 hover:bg-[#25D366] hover:border-[#25D366] hover:text-white transition-all duration-300">
